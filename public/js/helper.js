...
var setupDivs = function(){
  ...
  topBar = document.getElementById('topBar');
   ...
   bigDivs = [mainDiv,leftColumn,rightColumn,centerColumn,wordBox,bottomBar,
               topBar,content,avatars ,extraBubbles,createUser, options, dimmer, optionsButton, sendButton ];
   ...
   mainDiv.style.zIndex = "0";
    leftColumn.style.zIndex = "10";
     rightColumn.style.zIndex = "10";
      centerColumn.style.zIndex = "9";
       wordBox.style.zIndex = "71";
        bottomBar.style.zIndex = "70";
         topBar.style.zIndex = "97";
         content.style.zIndex = "30";
     avatars.style.zIndex = "40";
     extraBubbles.style.zIndex = "50";
     ...
     var bottomBarSize = {x:dX,y:100};
     var contentSize = {x:1600,y:800};
  ...
  sizeDiv(topBar, topBarSize.x, topBarSize.y);
   ...
   sizeDiv(bottomBar, bottomBarSize.x - wordBoxSize.x, bottomBarSize.y);
    ...
    sizeDiv(optionsButton,optionsButtonSize.x, optionsButtonSize.y);
     ...
     positionTopLeft(dimmer,0,0);
      ...
      positionTopLeft(wordBox,dX - wordBoxSize.x,dY-wordBoxSize.y);
       positionTopLeft(bottomBar, 0, dY-bottomBarSize.y);
